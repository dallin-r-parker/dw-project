...
angular.module('dw-store', ['ui.router', 'slick']).config(function ($stateProvider, $urlRouterProvider) {
...
angular.module('dw-store').controller('dapHeroCtrl', function ($scope) {});
'use strict';
...
angular.module('dw-store').controller('detailsCarouselCtrl', function ($scope) {});
'use strict';
...
angular.module('dw-store').controller('navDirCtrl', function ($scope, checkoutService) {
    $scope.message = 1;
